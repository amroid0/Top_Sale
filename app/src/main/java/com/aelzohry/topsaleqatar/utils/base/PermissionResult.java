...
public class PermissionResult<Input, Result> {
    /**
     * Register activity result using a {@link ActivityResultContract} and an in-place activity result callback like
     * the default approach. You can still customise callback using {@link #launch(Object, OnActivityResult)}.
     */
    @NonNull
    public static <Input, Result> PermissionResult<Input, Result> registerForActivityResult(
            @NonNull ActivityResultCaller caller,
            @NonNull ActivityResultContract<Input, Result> contract,
            @Nullable OnActivityResult<Result> onActivityResult) {
        return new PermissionResult<>(caller, contract, onActivityResult);
    }
     ...
     */
    @NonNull
    public static PermissionResult<String[], Map<String,Boolean>> registerActivityForResult(@NonNull ActivityResultCaller caller) {
    ...
    private PermissionResult(@NonNull ActivityResultCaller caller,
                             @NonNull ActivityResultContract<Input, Result> contract,
                             @Nullable OnActivityResult<Result> onActivityResult) {
